  ...
  return (
    <footer className="bg-slate-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        <div className="border-t border-gray-800 pt-6 md:pt-8 flex flex-col items-center text-center md:flex-row md:justify-between md:items-center md:text-left text-xs md:text-sm text-gray-500 gap-4">
